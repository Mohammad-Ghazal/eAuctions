          ...
          <div class="row">
            <div class="col-12 col-md-6 col-lg-3">
              <div class="kilimanjaro_part">
                <h5>About Us</h5>
                <p>
                  It includes rich features & content. It's designed & developed
                  based on One Page/ Multi-page Layout, blog themes, word press
            ...
            <div class="col-12 col-md-6 col-lg-3">
              <div class="kilimanjaro_part">
                ...
                <div class="kilimanjaro_single_contact_info">
                  <h5>Phone:</h5>
                  <p>
                    +255 255 54 53 52 <br /> +255 255 53 52 51
                  </p>
                </div>
                <div class="kilimanjaro_single_contact_info">
                  <h5>Email:</h5>
          ...
          <div class="row">
            <div class="col-12">
              <p>
                ...
                <a href="#">
                  My Footer<i class="fa fa-love"></i>
                </a>
              </p>
            </div>
          </div>
